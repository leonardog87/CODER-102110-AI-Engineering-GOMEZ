# Documentación de Agente Corporativo IA
...
| [Servidor MCP](mcp-server.md) | Transportes, herramientas y control por rol |
...
Los archivos Markdown de `manuales_complejos/` y `knowledge_base/` no forman
