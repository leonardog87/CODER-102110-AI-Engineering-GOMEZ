...
COMPLEX_CHUNK_SIZE = int(os.getenv("COMPLEX_CHUNK_SIZE", "800"))
COMPLEX_CHUNK_OVERLAP = int(os.getenv("COMPLEX_CHUNK_OVERLAP", "120"))
COMPLEX_RETRIEVAL_TOP_K = int(os.getenv("COMPLEX_RETRIEVAL_TOP_K", "2"))
COMPLEX_RETRIEVAL_CANDIDATES = int(os.getenv("COMPLEX_RETRIEVAL_CANDIDATES", "6"))
